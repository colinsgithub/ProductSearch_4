...
*/
					...
					var mesh = THREE.SceneUtils.createMultiMaterialObject( geometry, [ new THREE.MeshLambertMaterial( { color: color } ), new THREE.MeshBasicMaterial( { color: 0x000000, wireframe: false, transparent: false } ) ] );
					mesh.position.set( x , y , z );
					mesh.rotation.set( rx -1, ry, rz );
					//mesh.scale.set( s, s, s );
					group.add( mesh );
...
*/
				...
				arcShape.absarc( 10, 10, 5, 0, Math.PI*2, false );
				...
				var marker = 40;
				var marker = new THREE.Shape();
				marker.moveTo( 0, circleRadius );
				marker.quadraticCurveTo( circleRadius, circleRadius, circleRadius, 0 );
				marker.quadraticCurveTo( circleRadius, -circleRadius, 0, -circleRadius );
				marker.quadraticCurveTo( -circleRadius, -circleRadius, -circleRadius, 0 );
				marker.quadraticCurveTo( -circleRadius, circleRadius, 0, circleRadius );
...
/*
    ...
    */
                                addShape( arcShape, extrudeSettings, 0xbb4422, 0, 100, 0, 0, 0, 0, 1 );
/*
