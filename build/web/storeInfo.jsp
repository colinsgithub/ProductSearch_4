        ...
        <div id="header-wrapper">
            ...
            <div id="header-inner">
                <header>
                    ...
                    <!-- Navigation -->
                    <nav id="primary-nav">
                        <div class="menu-container metro">
                            <dl class="horizontal span11">
                                <dt>Store Name</dt>
                                <dd><%=store.getStoreName()%></dd>
                                <dt>Rank</dt>
                                <dd><%=store.getRank()%></dd>
                                <dt>Contact</dt>
                                <dd><%=store.getPhoneNumber()%></dd>
                                <dt>Create Time</dt>
                                <dd><%=store.getStoreCreateTime().toGMTString()%></dd>
                                <dt>Address</dt>
                                <dd><%=store.getAddress()%></dd>
                                <dt>Description</dt>
                                <dd><%=store.getStoreDesc()%></dd>
                            </dl>
                        </div>
                    </nav>
                        ...
                        <li class="metro">
                            <div class="es-caption" style="" data-caption="impact" data-caption-position="center" data-caption-width="550">
                                ...
                                <dl class="horizontal" id="info">
                                    ...
                                    <dt>Name</dt>
                                    <dd style="text-align: left;"><a href="#" id="userName" data-type="text" data-title="Enter User Name"></a></dd>
                                    <dt>Gender</dt>
                                    <dd style="text-align: left;"><a href="#" id="sex" data-type="text" data-title="Enter Sex"></a></dd>
                                    <dt>Age</dt>
                                    <dd style="text-align: left;"><a href="#" id="age" data-type="text" data-title="Enter Age"></a></dd>
                                    <dt>Credit</dt>
                                    <dd style="text-align: left;"></dd>
                                    <dt>Role</dt>
                                    <dd style="text-align: left;"></dd>
                                    <dt>Email</dt>
                                    <dd style="text-align: left;"><a href="#" id="email" data-type="text" data-title="Enter Email"></a></dd>
                                    <dt>Description</dt>
                                    <dd style="text-align: left;"><a href="#" id="userDesc" data-type="textarea" data-title="Enter Description"></a></dd>
                                </dl>
