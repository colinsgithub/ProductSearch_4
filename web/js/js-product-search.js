...
submitIt = function() {
//    $("#wrapper-body").load("getResult?keywords=" + $("#search-bar input").val() + " #wrapper-body");
    window.location.href = web + "/MainSearch?action=getResult&keywords=" + $("#search-bar input").val(); 
}
...
$(function() {
    ...
    $("#changetype-establishment").on("unchecked", function() {
